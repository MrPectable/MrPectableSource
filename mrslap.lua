...
-- Games
local LP = UI:addPage("Slap Battles 🖐",3,false,7)

LP:addLabel("Slap Battle Scripts","More Soon!")

LP:addButton("Slapper Hub",function()
